...
`size-10` not `w-10 h-10`. Applies to standalone icons, avatars, skeletons, etc. Does not apply to icons inside shadcn components — those are sized by the component, see [icons.md](./icons.md).
