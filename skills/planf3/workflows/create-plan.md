...
2. Explore Codebase - Understand existing patterns, architecture, relevant files, and prior specs to back-reference. If `AI_DOCS` exists, read it for AI/agent-facing documentation; if `APP_DOCS` exists, read it for application documentation.
