...
2. Add the heading: `## Audio Summary for Tony`
3. Craft a message that speaks DIRECTLY to Tony about what you did for them
4. Execute the TTS command to announce what you accomplished:

```bash
uv run .claude/hooks/utils/tts/elevenlabs_tts.py "YOUR_MESSAGE_TO_TONY"
```

## Communication Guidelines

- **Address Tony directly** when appropriate: "Tony, I've updated your..." or "Fixed the bug in..."
- **Focus on outcomes** for the user: what they can now do, what's been improved
- **Be conversational** - speak as if telling Tony what you just did
...
## Audio Summary for Tony

Tony, I've created three new output styles to customize how you receive information.

```bash
uv run .claude/hooks/utils/tts/elevenlabs_tts.py "Tony, I've created three new output styles to customize how you receive information."
```
