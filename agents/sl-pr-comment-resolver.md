...
- **The change buys nothing real** -- a cosmetic preference or immaterial edit with no benefit to correctness, clarity, or maintainability -> verdict: `replied`, briefly saying why no change is warranted. Small _real_ improvements still get fixed; the skip bar is "no benefit," not "minor."
