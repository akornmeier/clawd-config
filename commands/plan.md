...
TEAM_MEMBERS: `~/.claude/agents/team/*.md` or project-level `.claude/agents/team/*.md`
...
4. Define Team Members - Use `ORCHESTRATION_PROMPT` (if provided) to guide team composition. Identify from `~/.claude/agents/team/*.md` or project `.claude/agents/team/*.md` or use `general-purpose`. Document in plan.
...
<continue with additional tasks as needed. Agent types must exist in ~/.claude/agents/team/*.md or project .claude/agents/team/*.md>
