<template>
    <div class="agent-swim-lane">
            ...
            <div class="header-left">
                ...
                >
                    ...
                    <span
                        ...
                        :class="hoveredEventCount ? 'min-w-[65px]' : ''"
                    >
                        {{
                            hoveredEventCount
                ...
                >
                    ...
                    <span
                        class="text-xs font-bold"
                        :class="hoveredToolCount ? 'min-w-[75px]' : ''"
                    >
                        {{
                            hoveredToolCount
                ...
                >
                    ...
                    <span
                        class="text-sm font-bold text-[var(--theme-text-primary)]"
        ...
        <div ref="chartContainer" class="chart-wrapper">
            ...
            >
                <p
                    class="text-[var(--theme-text-tertiary)] text-sm font-semibold"
                >
